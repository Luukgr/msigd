...
enum series_t
{
	...
	HAS_LED_SETTING = MAG321CURV | MAG321QR | MAG321CQR | MAG272CQR | MAG272QR | MAG271CQR
		| MAG241CR | MAG271CR | MAG274GRP | MAG274GRP | MPG273CQR | MPG341CQR | MAG251RX | MAG274QRX | MAG341CQP,

	ALL     = MAG | PS341WU | MPG | QUERYONLY | MAG321QR | MPG27CQ | MAG251RX | MAG274QRX | MD272QP | MAG341CQP,
};
...
static std::vector<identity_t> known_models =
{
	...
	// MAG 341CQP QD-OLED (vendor 0x1462, product 0x3fa4) - identified by p150=V69; p140 byte is non-ASCII/unknown
	{ MAG341CQP,         "",      "V69", "MAG 341CQP", LT_STEEL },
};
...
static std::vector<setting_t *> settings(
{
	...
	new setting_t(MAG321CQR | MAG272GRP | MAG271CQR | MAG241GRP | MAG274GRP | MPG341CQR | MPG273CQR | MPG27CQ | MAG321QR | MD272QP | MAG341CQP,
	...
	new setting_t(PS341WU | MPG341CQR | MAG341CQP,
	...
	new setting_t(MAG321CURV | MAG321CQR | MAG271CQR | MAG241GRP | MPG341CQR | MPG27CQ | MAG274R | MAG341CQP,
	...
	new setting_t(MAG | MPG | MAG321QR | MAG251RX | MAG274QRX | MD272QP | MAG341CQP,
	...
	new setting_t(MAG321CURV | MAG272GRP | MAG274GRP | PS341WU | MPG341CQR | MPG273CQR | MAG321QR| MAG251RX | MAG274QRX | MAG341CQP,
	...
	new setting_t(PS341WU | MAG321CURV | MAG321CQR | MAG271CQR | MPG341CQR | MPG27CQ | MAG274QRX | MAG341CQP,
		                                   "00630", "pip_size", {"small", "medium", "large"}),
	new setting_t(PS341WU | MAG321CURV | MAG321CQR | MAG271CQR | MPG341CQR | MPG27CQ | MAG341CQP,
	...
	new setting_t(PS341WU | MAG321CURV | MAG321CQR | MAG271CQR | MPG341CQR | MPG27CQ | MAG274QRX | MAG341CQP, WRITE,
		                                   "00650", "toggle_display", {"-off", "on"}),  // returns 56006
	new setting_t(MAG321CURV | MAG321CQR | MAG271CQR | MPG27CQ | MAG274QRX | MAG341CQP, WRITE,
	...
	new setting_t(PS341WU | MPG341CQR | MPG27CQ | MAG341CQP,
